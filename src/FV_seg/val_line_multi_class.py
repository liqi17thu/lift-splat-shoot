...
def main():
    ...
    for i in range(sample_num):
        ...
        mask_pred_IPM = ipm(masks_pred[None], Ks, RTs, post_RTs=post_RTs, visual_sum=True)
        images = images.permute(0, 2, 3, 1)
        mask_pred_IPM = mask_pred_IPM[0]
        ...
        for j in range(6):
            ...
            plt.imshow(mask_pred[1], cmap='Reds', vmin=0, vmax=1, alpha=0.6)
            plt.imshow(mask_pred[2], cmap='Greens', vmin=0, vmax=1, alpha=0.6)
            plt.imshow(mask_pred[3], cmap='Blues', vmin=0, vmax=1, alpha=0.6)
        ...
        plt.imshow(mask_pred_IPM[1], cmap='Reds', vmin=0, vmax=1, alpha=0.6)
        plt.imshow(mask_pred_IPM[2], cmap='Greens', vmin=0, vmax=1, alpha=0.6)
        plt.imshow(mask_pred_IPM[3], cmap='Blues', vmin=0, vmax=1, alpha=0.6)
